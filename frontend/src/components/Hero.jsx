  ...
  return (
   <div> 
        ...
        <div className='text-center h-auto bg-slate-500  text-gray-900  py-24 px-12 bg-cover bg-center bg-no-repeat'>
            ...
            <h2 className='text-2xl text-slate-100 md:text-6xl xl:text-7xl font-bold
            tracking-tight mb-12'>
            ...
            <h3 className='pt-4 text-slate-100 md:text-6xl xl:text-7xl text-2xl font-bold tracking-tight mb-12'> Blockchain Timestamps</h3>
