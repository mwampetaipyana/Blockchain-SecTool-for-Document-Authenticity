  ...
  return (
    <div className='flex gap-4 w-full'>
            <BoxWrapper >
              ...
              <div className='pl-4'>
                <span className='text-sm text-neutral-900  font-bold'>Total PROs</span>
            ...
            <div className='rounded-full h-12 w-12 flex items-center justify-center bg-sky-500'>
              ...
              <div className='pl-4'>
                <span className='text-sm text-neutral-900 font-bold'>Total Documents</span>
                <div className='flex items-center'>
                  <strong className='text-xl text-gray-700 font-semibold '>345</strong>
            ...
            <FaCircleCheck className='text-2xl text-white '/>
              ...
              <div className='pl-4'>
                <span className='text-sm text-neutral-900  font-bold'>Total Verification</span>
                <div className='flex items-center'>
            ...
            <div className='rounded-full h-12 w-12 flex items-center justify-center bg-sky-500'>
              ...
              <div className='pl-4'>
                <span className='text-sm text-neutral-900 font-bold'>Total Failure</span>
                <div className='flex items-center'>
                  <strong className='text-xl text-gray-700 font-semibold '>34</strong>
